...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/auth/**").permitAll()
                ...
                .antMatchers(HttpMethod.POST,"/vacation_leave").hasRole("EMPLOYEE")
                .antMatchers(HttpMethod.GET,"/employee/*/vacationLeave").hasRole("EMPLOYEE")
                .antMatchers(HttpMethod.PUT,"/vacationLeave/*").hasRole("EMPLOYEE")
                .antMatchers(HttpMethod.DELETE,"/vacationLeave/*").hasRole("EMPLOYEE")

                // All Permissions

                .antMatchers("/employee/**", "/vacation_leave/**","/user/**","/role/**").hasRole("ADMIN");
